...
func checkCapabilities(fd uintptr) (deviceInfo string, busInfo string, supportsVideoCapture bool, supportsVideoStreaming bool, err error) {
	...
	deviceInfo = string([]byte(caps.card[:]))
